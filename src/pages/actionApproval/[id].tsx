...
const ActionApproval = () =>{
  ...
  const dataa = {
    cashoutValue: 1,
    appliedHours:5,
    dateSigned:'29-07-2022',
    approvalReason: "I need urgent money",
              ...
              <CardContent>
                <Box sx={{mb: '10px'}}>
                  <Typography variant="body1"  sx={{width:'200px',display: 'inline-block',verticalAlign:'middle'}}>Applied Hours </Typography> :
                   <Typography variant='body2' component="span" sx={{ml:8,verticalAlign:'middle'}}>{dataa?.appliedHours} </Typography>
                </Box>
                <Box sx={{mb: '10px'}}>
                  <Typography variant="body1"  sx={{width:'200px',display: 'inline-block',verticalAlign:'middle'}}>Cashout Value </Typography> :
                  <Typography variant='body2' component="span" sx={{ml:8,verticalAlign:'middle'}}>{dataa?.cashoutValue} </Typography>
                </Box>
                <Box sx={{mb: '10px'}}>
                  <Typography variant="body1"  sx={{width:'200px',display: 'inline-block',verticalAlign:'middle'}}>Date </Typography> :
                  <Typography variant='body2' component="span" sx={{ml:8,verticalAlign:'middle'}}>{dataa?.dateSigned}</Typography>
                </Box>
                <Box sx={{mb: '10px'}}>
                  <Typography variant="body1"  sx={{width:'200px',display: 'inline-block',verticalAlign:'middle'}}>{dataa.approvalReason ? 'Approval reason' : 'Rejected reason' } </Typography> :
                  <Typography variant='body2' component="span" sx={{ml:8,verticalAlign:'middle'}}>{dataa?.approvalReason}</Typography>
                </Box>
                <Box sx={{mb: '10px'}}>
