        ...
        >
          <BoxWrapper>
            <Box sx={{ mb: 6 }}>
              ...
              <Typography variant='body2' sx={{mb: 7}}>Please enter the verification code and set new password for your email.</Typography>
...
ConfirmPassword.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>
